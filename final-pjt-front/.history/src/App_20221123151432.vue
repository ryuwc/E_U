            ...
            <ul>
              ...
              <li v-if="isLogin" style="margin-left: 600px;">
                <div class="dropdown hover:scale-125">
                  ...
                  <ul style="border: none; background-color: rgba(0, 0, 0, 0); margin-right: 50px;" class="dropdown-menu">
                    <li><router-link to="/edit"><a id="profilemenu" class="dropdown-item" href="#">정보수정</a></router-link></li>
                    <li @click.prevent="logOut"><a id="profilemenu" class="dropdown-item" href="#">Another action</a></li>
