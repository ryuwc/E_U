<template>
  <div class="random" style="margin-top: 7rem;">
    <br>
      <div class="text-box"
    ...
    >
      <div class="text-center fw-bold"><span style="font-size:x-large">이</span></div>
      <div class="text-center fw-bold"><span style="font-size:x-large">:</span></div>
      <div class="text-center fw-bold"><span style="font-size:x-large">유</span></div>
