    ...
    <div class="container w-full px-4 py-16 mx-auto space-y-16 lg:px-8 lg:py-32">
      ...
      <VueSlickCarousel v-bind="settings" ref="carousel" :arrows="false">
        ...
        <div
          ...
          class="relative flex flex-shrink-0 w-full px-10 mx-10 overflow-hidden rounded-lg shadow-lg group rotate-1 sm:w-auto"
        ...
        >
          <div class="absolute inset-0 flex items-end justify-center p-4 text-white bg-gradient-to-t from-black/90 via-transparent z-1">
            <div class="text-center">
              <h4 class="mb-1 text-xl font-semibold">{{ movie.title }}</h4>
            </div>
          </div>
          <div style="width: 20vw; height: 20vw" class="w-64 transition duration-150 ease-out bg-cover h-60 group-hover:scale-110">
            <img class="w-full h-auto" :src="`https://image.tmdb.org/t/p/original${movie.poster_path}`" />
          </div>
        </div>
        <div class="px-20">
          <div class="relative flex flex-shrink-0 w-full sm:w-auto">
            <img
              src="https://file.mk.co.kr/meet/neds/2021/07/image_readmed_2021_659579_16257086594710103.jpg"
