  ...
  <div class="bg-white">
    <div class="container w-full px-4 py-16 mx-auto space-y-16 lg:px-8 lg:py-32">
      ...
      >
        <!-- 이거 하나씩 시작 -->
        <div
          class="relative flex justify-between flex-shrink-0 w-full px-10 mx-10 overflow-hidden rounded-lg shadow-lg group rotate-1 sm:w-auto"
        ...
        >
          <div class="absolute inset-0 flex items-end justify-center p-4 text-white bg-gradient-to-t from-black/90 via-transparent z-1">
            <div class="text-center">
              <h4 style="z-index: 2;" class="mb-1 text-xl font-semibold">{{ movie.title }}</h4>
            </div>
          </div>
