    ...
    <div class="flex grid grid-cols-10 gap-10">
      ...
      <div id="left" style="width: 80%" class="col-span-6 md:w-10">
        <div class="relative top-8 left-10 right-10">
          <p class="mb-2 text-6xl font-medium">{{ movie.title }}</p>
          <p class="mb-2 text-4xl">{{ movie.thisMovieGenre.join(', ') }}</p>
          <p class="mb-2 text-3xl">{{ movie.release_date }} 개봉</p>
          <p id="overview" class="text-lg leading-normal">{{ movie.overview }}</p>
