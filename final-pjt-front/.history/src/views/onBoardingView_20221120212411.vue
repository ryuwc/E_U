...
export default {
  ...
  data() {
    ...
    //   logo: this.getId('logo'),
    //   navText: this.getClass('nav_text'),
    //   hiddenNavText: this.getClass('hidden_nav_list_text'),
    //   headerBtnSignin: this.getClass('header_button_signin'),
    }
  },
  methods: {
    getId: (id) => {
  ...
  computed: {
    ...
    navText() {
      return this.getClass('nav_text');
    },
    hiddenNavText() {
      return this.getClass('hidden_nav_list_text');
    },
    headerBtnSignin() {
      return this.getClass('header_button_signin');
    },
  },
  mounted() {
    this.main();
