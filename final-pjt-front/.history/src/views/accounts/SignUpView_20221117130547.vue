      ...
      <div class="flex items-center justify-center w-full p-4 py-0 mx-auto min-h-fit max-w-10xl lg:px-8 bg-gray-200/50">
        ...
        <div class="w-full max-w-5xl lg:py-16">
          ...
          <div class="flex flex-col overflow-hidden shadow-sm md:flex-row rounded-xl">
            ...
            <!-- END Sign Up Extra -->
            <div class="relative flex items-center px-6 py-10 bg-blue-900 bg-cover md:px-10 lg:p-16 md:w-1/2 bg-opacity-80" style="background-image: url('https://images.unsplash.com/photo-1485846234645-a62644f84728?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1459&q=80');">
