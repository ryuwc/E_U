...
<template>
  ...
  <div class="relative overflow-hidden bg-white">
    ...
    <div class="absolute inset-0 flex">
      <div
        class="w-1/4 h-64 bg-gradient-to-r from-blue-400 to-violet-400"
      ></div>
      <div class="w-1/4 h-64 bg-gradient-to-r from-violet-400 to-red-400"></div>
      <div class="w-1/4 h-64 bg-gradient-to-r from-red-400 to-orange-400"></div>
      <div
        class="w-1/4 h-64 bg-gradient-to-r from-orange-400 to-amber-400"
      ></div>
    </div>
    <div class="absolute inset-0">
      <div class="h-64 bg-gradient-to-b from-transparent to-white"></div>
    </div>
    ...
    <header
      id="page-header"
      class="relative flex items-center flex-none py-5 bg-white shadow-sm bg-opacity-40"
    >
      <div
        class="container flex flex-col px-4 mx-auto space-y-6 text-center xl:max-w-7xl lg:px-10 md:flex-row md:items-center md:justify-between md:space-y-0 md:space-x-8"
      >
        <!-- Brand -->
        <div class="flex items-center justify-center flex-none">
          <a
            href="#"
            class="inline-flex items-center space-x-2 text-lg font-bold tracking-wide text-blue-900 hover:text-blue-700"
          >
            <svg
              class="inline-block w-5 h-5 text-blue-500 hi-solid hi-fire"
              fill="currentColor"
              viewBox="0 0 20 20"
        ...
        <div
          class="flex flex-col space-y-6 text-center grow md:flex-row md:items-center md:justify-between md:space-y-0 md:space-x-8"
        >
          <!-- Navigation -->
          ...
          <div class="flex items-center justify-center space-x-2">
            ...
            >
              <svg
                class="inline-block w-4 h-4 opacity-50 hi-solid hi-shopping-cart"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
    ...
    <!-- Hero Content -->
    <div
      class="container relative px-4 py-16 mx-auto text-center xl:max-w-7xl lg:px-8 lg:py-32"
    >
      <div
        class="inline-flex px-2 py-1 mb-2 text-sm font-semibold leading-4 border rounded text-amber-700 bg-amber-200 border-amber-300"
      >
        New UI components are now in!
      </div>
      <div
        class="flex items-center justify-center w-24 h-24 mx-auto my-10 text-white bg-blue-600 border border-blue-800 rounded-full ring-4 ring-blue-300 -rotate-6"
      >
        <svg
          class="inline-block w-10 h-10 hi-solid hi-fire"
          fill="currentColor"
          viewBox="0 0 20 20"
          xmlns="http://www.w3.org/2000/svg"
        >
      ...
      <h1 class="mb-4 text-3xl font-extrabold md:text-4xl">
      ...
      <div
        class="flex flex-col py-10 space-y-2 sm:flex-row sm:items-center sm:justify-center sm:space-y-0 sm:space-x-2"
      >
        <a
          href="#"
          class="inline-flex items-center justify-center px-4 py-3 space-x-2 font-semibold leading-6 text-white bg-gray-700 border border-gray-700 rounded focus:outline-none hover:text-white hover:bg-gray-800 hover:border-gray-800 focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-gray-700 active:border-gray-700"
        >
          <span>Get Started</span>
          <svg
            class="inline-block w-5 h-5 opacity-50 hi-solid hi-arrow-right"
            fill="currentColor"
            viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg"
          >
      ...
      <div
        class="flex flex-col items-center justify-center space-y-2 sm:flex-row sm:space-y-0 sm:space-x-3"
      >
        <a
          href="#"
        ...
        <a
          href="#"
          class="text-sm font-semibold text-gray-600 underline hover:text-gray-500"
        >
              ...
              >
                ...
                <div class="py-1">
                  <a
                    ...
                    tabindex="0"
                    class="flex justify-between w-full px-4 py-2 text-sm leading-5 text-left text-gray-700"
                    role="menuitem"
                    >Account settings</a
                  >
                  <a
                  ...
                  <span
                    role="menuitem"
                    tabindex="-1"
                    class="flex justify-between w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 opacity-50 cursor-not-allowed"
                    aria-disabled="true"
