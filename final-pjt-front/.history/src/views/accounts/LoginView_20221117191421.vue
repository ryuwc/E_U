          ...
          <div class="flex flex-col overflow-hidden shadow-sm md:flex-row rounded-xl">
            ...
            <section class="px-6 py-10 bg-white md:px-10 lg:p-16 md:w-1/2">
              <form class="space-y-6" @submit.prevent="login({username: username, password: password})">
                <div class="space-y-1">
                  <input class="block w-full px-3 py-2 leading-6 placeholder-gray-400 bg-white border rounded shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" type="text" id="name" name="name" placeholder="아이디를 입력해주세요"
                  v-model="username"
                  >
                </div>
                <div class="space-y-1">
