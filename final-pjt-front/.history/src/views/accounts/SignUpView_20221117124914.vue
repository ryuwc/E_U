...
<template>
  ...
  <div id="page-container" class="flex flex-col w-full min-h-screen mx-auto bg-gray-100">
    ...
    <main id="page-content" class="flex flex-col flex-auto max-w-full">
      <div class="flex items-center justify-center w-full min-h-screen px-4 py-0 mx-auto max-w-10xl lg:p-8 bg-gray-200/50">
        <!-- Sign Up Section -->
          ...
          <div class="flex flex-col overflow-hidden shadow-sm md:flex-row rounded-xl">
            ...
            <section class="px-6 py-10 bg-white md:px-10 lg:p-16 md:w-1/2">
              <form class="space-y-6">
                ...
                <div class="space-y-1">
                  <input class="block w-full px-3 py-2 leading-6 placeholder-gray-400 border border-gray-200 rounded focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" type="text" placeholder="Enter your email">
                </div>
                <div class="space-y-1">
