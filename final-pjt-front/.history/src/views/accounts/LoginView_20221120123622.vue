          ...
          >
            ...
            <section class="px-6 py-10 bg-white md:px-10 lg:p-16 md:w-1/2">
              ...
              >
                <div class="space-y-1">
                  <input
                    class="block w-full px-3 py-2 leading-6 placeholder-gray-400 bg-white border rounded shadow-sm shadow-md focus:outline-none focus:border-sky-500 focus:ring-sky-500 sm:text-sm focus:ring-1"
                    type="text"
                    id="name"
                    name="name"
                ...
                <div class="space-y-1">
                  <input
                    class="block w-full px-3 py-2 leading-6 placeholder-gray-400 border rounded focus:outline-none focus:border-sky-500 focus:ring-sky-500 sm:text-sm focus:ring-1"
                    type="password"
                    id="password_confirm"
                    name="password"
