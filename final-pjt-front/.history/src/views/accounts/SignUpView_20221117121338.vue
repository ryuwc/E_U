          ...
          <div class="flex flex-col overflow-hidden shadow-sm md:flex-row rounded-xl">
            ...
            <section class="px-6 py-10 bg-white md:px-10 lg:p-16 md:w-1/2">
              <form class="space-y-6">
                <div class="space-y-1">
                  <label for="name" class="ml-1 text-sm font-medium">아이디</label>
                ...
                <div class="space-y-1">
                  <label for="email" class="text-sm font-medium">닉네임</label>
                ...
                <div class="space-y-1">
                  <label for="password_confirm" class="text-sm font-medium">비밀번호(확인)</label>
