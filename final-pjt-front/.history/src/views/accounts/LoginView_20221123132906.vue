...
<template>
  ...
  <div
    id="page-container"
    class="flex flex-col w-full h-screen mx-auto bg-gray-200/50"
  >
    <!-- Page Content -->
    <main id="page-content" class="flex flex-col flex-auto max-w-full">
      <div
        class="flex items-center justify-center w-full p-4 py-0 mx-auto min-h-fit max-w-10xl lg:px-8 bg-gray-200/50"
      >
        <!-- Sign Up Section -->
          ...
          >
            ...
            <section class="px-6 py-10 bg-white md:px-10 lg:p-16 md:w-1/2">
              ...
              >
                <div class="space-y-1">
                  <input
                    class="block w-full px-3 py-2 leading-6 placeholder-gray-400 bg-white border rounded shadow-lg focus:outline-none focus:border-sky-500 focus:ring-sky-500 sm:text-sm focus:ring-1"
                    type="text"
                    id="name"
                    name="name"
                ...
                <div class="space-y-1">
                  <input
                    class="block w-full px-3 py-2 leading-6 placeholder-gray-400 border rounded shadow-lg focus:outline-none focus:border-sky-500 focus:ring-sky-500 sm:text-sm focus:ring-1"
                    type="password"
                    id="password_confirm"
                    name="password"
