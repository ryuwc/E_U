<template>
  <div class="container relative mx-auto">
      <div class="absolute inset-0 flex items-center justify-between w-full h-full top-3">
      ...
      <div class="flex items-center justify-center w-full h-full px-4 py-24 mt-32 sm:py-8">
          <div class="slider">
              <div class="slide-ana">
