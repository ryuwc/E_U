  ...
  <div>
    ...
    >
      <div class="relative w-auto pointer-events-none modal-dialog"
        style="width: 1280px; height: 720px; margin-left: auto; margin-right: auto;"
      >
        <div
          class="relative flex flex-col w-full h-full text-current bg-white border-none rounded-md shadow-lg outline-none pointer-events-auto modal-content bg-clip-padding"
        >
