  ...
  <div class="relative flex flex-col px-6 pt-8 bg-white border border-gray-200 group md:px-8 rounded-xl">
    <blockquote class="relative flex flex-col grow">
      ...
      <p class="mb-3 text-sm font-medium leading-relaxed text-gray-700 grow">
        This is an amazing, multi purpose, and very well designed and structured template. I rarely share feedback about my purchases but this product deserves
        the support. It is distinguished.
      </p>
      <footer class="flex items-center flex-none space-x-4">
        ...
        <div>
          <a href="#" class="font-semibold text-blue-600 hover:text-blue-400"> Alex Sader </a>
          <p class="text-sm font-medium text-gray-500">Web Developer</p>
        </div>
      </footer>
    </blockquote>
  </div>
