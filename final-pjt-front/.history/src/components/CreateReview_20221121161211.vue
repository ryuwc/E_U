      ...
      <blockquote class="relative flex flex-col grow">
        <div class="flex items-center ml-3">
          <div class="flex items-center mr-3">
            ...
            <p style="margin-bottom: 0;" class="text-lg">{{ user.nickname ? user.nickname : user.username }}</p>
          </div>
          
        </div>
        <div class="w-full mt-3">
          <textarea rows="1" class="w-full p-2 border rounded" placeholder="리뷰를 남겨주세요!"></textarea>
        </div>
