  ...
  <div class="relative flex flex-col px-6 pt-4 bg-white border border-gray-200 group md:px-8 rounded-xl">
    <blockquote class="relative flex flex-col grow">
      ...
      <footer class="flex items-center justify-between flex-none space-x-4">
        ...
        />
        <div class="absolute top-0 bottom-0 left-0 right-0 flex items-center justify-center bg-opacity-50 bg-slate-800">
          <div class="px-16 text-center bg-white rounded-md py-14">
            ...
            <button class="px-4 py-2 text-white bg-red-500 rounded-md text-md">Cancel</button>
