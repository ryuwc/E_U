          ...
          <div class="relative w-auto pointer-events-none modal-dialog">
            ...
            >
              ...
              <div class="flex flex-wrap items-center justify-end flex-shrink-0 p-4 border-t border-gray-200 modal-footer rounded-b-md">
                ...
                <button
                  type="button"
                  class="px-6 py-2.5 text-black font-semibold border-none text-base leading-tight uppercase rounded shadow-md hover:bg-red-500 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg transition duration-150 ease-in-out ml-1"
                >
                  네!
                </button>
              </div>
