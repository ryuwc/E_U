<template>
  <div>
    <!-- 개별 영화 썸네일 -->
    <div style="position: relative; cursor: pointer; margin-bottom: 13px" v-for="(video, index) in videos" :key="index"
    ...
    >
      <div class="relative w-auto pointer-events-none modal-dialog"
        style="width: 1280px; height: 720px; margin-left: auto; margin-right: 1100px; margin-top: 300px;"
      >
        <div
          class="relative flex flex-col text-current bg-white border-none rounded-md shadow-lg outline-none pointer-events-auto modal-content bg-clip-padding"
