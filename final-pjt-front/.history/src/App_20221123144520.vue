    ...
    <body>
      <header id="header">
        <div class="header">
          ...
          <router-link to="/home"><img src="./image/logo.png"
          style="width: 65px; height: 65px; margin-left: 100px; margin-top: 20px; margin-bottom: 20px;"
          ></router-link>
          ...
          <nav>
            <ul>
              ...
              <li>
                <div class="list">
                  <router-link to="/random"><a href=""><h3 class="nav_text">랜덤영화</h3></a></router-link>
                </div>
              </li>
              <li>
                <div class="list">
